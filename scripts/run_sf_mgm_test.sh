...
LOGFILE="${SCRIPT_DIR}/run_sf_mgm_test.log"
...
cfg_docker="/data/satellite/argentina/san_fernando/mgm_test_config.json"
out_host="${DIR_DATA}/satellite/argentina/san_fernando/2_s2p-hd/output_mgm_test"
ID_GPU=${ID_GPU:-7}
