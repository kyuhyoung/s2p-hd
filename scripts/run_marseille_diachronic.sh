...
# 입력: 1_sat-ba/pan/IMG_PNEO3_<ts>_PAN.tif (BA보정 RPC), diachronic_config.json
...
LOGFILE="${SCRIPT_DIR}/run_marseille_diachronic.log"
: > "$LOGFILE"
...
echo -e "${GREEN}=================================================${NC}"
echo -e "${GREEN}  Marseille (PNEO3 PAN tri-stereo) Diachronic(MonSter)${NC}"
