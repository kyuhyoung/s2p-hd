...
# 입력: pan_aoi/{522,544,554}.tif (PAN 1밴드 직접 — RGB 추출 없음), diachronic_config.json
...
LOGFILE="${SCRIPT_DIR}/run_sf_diachronic.log"
: > "$LOGFILE"
...
cfg_host="${DIR_DATA}/${REL}/diachronic_config.json"
cfg_docker="/data/${REL}/diachronic_config.json"
out_host="${DIR_DATA}/${REL}/2_s2p-hd/output_diachronic"
