...
class MultiBasicEncoder(nn.Module):
    def __init__(
        self, input_dim=3, output_dim=[128], norm_fn="batch", dropout=0.0, downsample=3
    ):
        ...
        self.in_planes = 64
        self.layer1 = self._make_layer(64, stride=1)  # // 1 -> 1
        self.layer2 = self._make_layer(96, stride=1 + (downsample > 1))  # // 2 -> 2
        self.layer3 = self._make_layer(128, stride=1 + (downsample > 0))  # // 2 -> 4
        self.layer4 = self._make_layer(128, stride=2)  # // 2 -> 8
        self.layer5 = self._make_layer(128, stride=2)  # // 2 -> 16
