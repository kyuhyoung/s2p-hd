...
from fs_core.utils.utils import bilinear_sampler
...
class Combined_Geo_Encoding_Volume:
    def __init__(self, init_fmap1, init_fmap2, geo_volume, num_levels=2, dx=None):
        ...
        geo_volume = (
            geo_volume.permute(0, 3, 4, 1, 2).reshape(b * h * w, c, 1, d).contiguous()
        )
    ...
    def __call__(self, disp, coords, low_memory=False):
        ...
        for i in range(self.num_levels):
            ...
            init_corr = bilinear_sampler(
                init_corr, init_coords_lvl, low_memory=low_memory
            )
