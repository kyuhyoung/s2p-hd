...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/data2/cjd/mono_fusion/checkpoints/kitti.pth",
    )
    ...
    parser.add_argument(
        ...
        default="/data2/cjd/StereoDatasets/kitti/2012/testing/colored_0/*_10.png",
    )
    parser.add_argument(
        "-r",
        "--right_imgs",
        help="path to all second (right) frames",
        default="/data2/cjd/StereoDatasets/kitti/2012/testing/colored_1/*_10.png",
    )

    parser.add_argument(
        "--output_directory", help="directory to save output", default="kitti_2012"
    )
    parser.add_argument(
