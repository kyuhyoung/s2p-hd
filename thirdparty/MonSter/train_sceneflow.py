    ...
    while should_keep_training:
        ...
        for data in tqdm(
            ...
            if total_step % 20 == 0 and accelerator.is_main_process:
                ...
                accelerator.log(
                    {
                        "disp_pred": wandb.Image(
                            disp_preds_np, caption="step:{}".format(total_step)
                        )
                    },
                    total_step,
                )
                accelerator.log(
                    {
                        "disp_gt": wandb.Image(
                            disp_gt_np, caption="step:{}".format(total_step)
                        )
                    },
                    total_step,
                )
                accelerator.log(
                    {
                        "depth_mono": wandb.Image(
                            depth_mono_np, caption="step:{}".format(total_step)
                        )
                    },
                    total_step,
                )
            ...
            if (total_step > 0) and (total_step % cfg.val_frequency == 0):
                ...
                for data in tqdm(
                    ...
                    epe, out = accelerator.gather_for_metrics(
                        (
                            epe[(valid >= 0.5) & (disp_gt.abs() < 192)].mean(),
