...
def eulerAnglesToRotationMatrix(theta):
    ...
    R_x = np.array(
        [[1, 0, 0], [0, cos_theta_0, -sin_theta_0], [0, sin_theta_0, cos_theta_0]]
    )

    R_y = np.array(
        [[cos_theta_1, 0, sin_theta_1], [0, 1, 0], [-sin_theta_1, 0, cos_theta_1]]
    )

    R_z = np.array(
        [[cos_theta_2, -sin_theta_2, 0], [sin_theta_2, cos_theta_2, 0], [0, 0, 1]]
    )
